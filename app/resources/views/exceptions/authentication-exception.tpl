...
<p>Heb je de credentials al gedownload? Verplaats dan het bestand <code>credentials.json</code> in de map <code>overhemd/google/</code>.</p>
...
<ul>
    ...
    <li>Plaats de bestanden <code>credentials.json</code> en <code>token.json</code> in de map <code>overhemd/google/</code>.</li>
</ul>
{/block}